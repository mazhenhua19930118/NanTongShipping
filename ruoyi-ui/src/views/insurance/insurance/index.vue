<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['insurance:insurance:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['insurance:insurance:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['insurance:insurance:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['insurance:insurance:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="insuranceList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="保险状态" align="center" prop="insuranceStatus" />
...
<script>
import { listInsurance, getInsurance, delInsurance, addInsurance, updateInsurance } from "@/api/insurance/insurance"
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('insurance/insurance/export', {
        ...this.queryParams
